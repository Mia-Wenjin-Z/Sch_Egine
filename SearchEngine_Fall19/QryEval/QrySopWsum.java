...
//    public QrySopWsum(ArrayList<Double> weightVector) {
//        super(weightVector);
//    }//to-delete
    ...
    public double getScore(RetrievalModel r) throws IOException {
        ...
        if (r instanceof RetrievalModelIndri) {
            ...
            throw new IllegalArgumentException("#WSUM cannot be applied to" + r.getClass().getName());
        }
    }
        ...
        if (this.docIteratorHasMatchCache()) {
            ...
            for (int i = 0; i < this.args.size(); i++) {
                ...
                if (q_i.docIteratorHasMatchCache() && q_i.docIteratorGetMatch() == doc_id) {
                    score += weight * ((QrySop) q_i).getScore(r) / sumWeight;
                } else {
                    score += weight * ((QrySop) q_i).getDefaultScore(r, doc_id) / sumWeight;
                }
            }
        }
        return score;
